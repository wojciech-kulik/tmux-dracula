...
main()
{
  ...
  # Window option
  if $show_powerline; then
    tmux set-window-option -g window-status-current-format "#[fg=${gray},bg=${dark_purple}]${left_sep}#[fg=${white},bg=${light_purple}] #I #W${current_flags} #[fg=${light_purple},bg=${gray}]${left_sep}"
  else
